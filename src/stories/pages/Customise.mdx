...
The design tokens (colours, font styles and hierarchy, border radius, etc.) of Pallote are fully customisable.

Learn here how to override the different styles of Pallote CSS to suit your own design system.
...
To view the full list of available variables, see [variables]((?path=/docs/variables--docs)) page.
